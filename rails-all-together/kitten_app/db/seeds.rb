...
# t.string :date
Playdate.create(person_id: peep1.id, kitten_id: kitten1.id,time:100, date:"12-8-20" )
Playdate.create(person_id: peep3.id, kitten_id: kitten4.id,time:50, date:"12-9-20" )
Playdate.create(person_id: peep1.id, kitten_id: kitten1.id,time:75, date:"12-9-20" )
